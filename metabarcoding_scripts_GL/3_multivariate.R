...
write_csv(gaviota_pres_abs_broadtax, file = here("metabarcoding_scripts_GL", "gaviota_pres_abs_broadtax.csv"))

# make samples_wide_common_name a .csv to use in 4_proportions for Q1  
write_csv(gaviota_pres_abs_common_name, file = here("metabarcoding_scripts_GL", "gaviota_pres_abs_common_name.csv"))

# make samples_wide_curated_species a .csv to use in 4_proportions for Q1  
write_csv(gaviota_pres_abs_curated_species, file = here("metabarcoding_scripts_GL", "gaviota_pres_abs_curated_species.csv"))

# make prey_count a .csv to use in 4_proportions for Q2
write_csv(prey_count, file = here("metabarcoding_scripts_GL", "prey_count.csv"))
